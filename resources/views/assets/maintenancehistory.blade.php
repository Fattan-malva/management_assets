                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($histories->condition === 'Good')
                                        <span class="badge"
                                            style="padding: 5px 15px; color: #fff; border-radius: 0.5em; background-color:rgba(2, 237, 61, 0.2); color:#149c87;">Good</span>
                                    @elseif ($histories->condition === 'Exception')
                                        <span class="badge"
                                            style="padding: 5px 15px; color: #fff; border-radius: 0.5em; background-color: rgba(254, 215, 19, 0.4); color:#fca308;">Exception</span>
                                    @elseif ($histories->condition === 'Bad')
                                        <span class="badge"
                                            style="padding: 5px 15px; color: #fff; border-radius: 0.5em; background-color:rgba(255, 0, 0, 0.2); color:red;">Bad</span>
                                    @else
                                        <span class="badge"
                    ...
                    <ul class="list-unstyled legend-list">
                        <li>
                            <span class="badge legend-badge"
                                style="padding: 5px 10px; color:#fff; background-color:rgba(2, 237, 61, 0.2); color:#149c87;">Good</span> : <span
                                class="legend-description">Assets are still good.</span>
                        </li>
                        <li>
                            <span class="badge legend-badge"
                                style="padding: 5px 10px; color:#fff; background-color: rgba(254, 215, 19, 0.4); color:#fca308;">Exception</span> :
                            <span class="legend-description">The asset is still suitable for use.</span>
                        </li>
                        <li>
                            <span class="badge legend-badge"
                                style="padding: 5px 10px; color:#fff; background-color:rgba(255, 0, 0, 0.2); color:red;">Bad</span> : <span
